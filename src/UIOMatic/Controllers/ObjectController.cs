...
namespace UIOMatic.Controllers
{
    ...
    public class ObjectController : UmbracoAuthorizedJsonController
    {
        ...
        public IEnumerable<Models.UIOMaticPropertyInfo> GetAllProperties(string typeName, bool isEdit, bool isList)
        {
            var ctrl = Activator.CreateInstance(Config.DefaultObjectControllerType, null);
            return ((IUIOMaticObjectController)ctrl).GetAllProperties(typeName, isEdit, isList);
        }
