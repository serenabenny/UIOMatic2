angular.module("umbraco.resources")
	.factory("uioMaticObjectResource", function ($http) {
	    return {
	        ...
	        getAllProperties: function (type,isedit,islist) {
	            return $http.get(Umbraco.Sys.ServerVariables.uioMatic.ocBaseUrl + "GetAllProperties?typeName=" + type + "&isEdit=" + isedit + "&isList=" + islist);
	        },
